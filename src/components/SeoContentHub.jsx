...
export const SeoContentHub = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'توفر تربو كوول توريداً وتركيباً مجانياً خلال 24 ساعة لجميع الأجهزة في الجيزة والقاهرة الكبرى و6 أكتوبر والشيخ زايد والتجمع الخامس، مع معاينة هندسية مجانية وضمان 10 سنوات على الكمبروسور و 5 على الجهاز بالكامل.'
    },
    {
