...
export const SeoContentHub = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'توفر تربو كوول توريداً وتركيباً مجانياً خلال 24 ساعة لجميع الأجهزة في الجيزة والقاهرة الكبرى و6 أكتوبر والشيخ زايد والتجمع الخامس، مع معاينة هندسية مجانية. ضمان أوكس 10 سنوات على الكمبروسور و 5 على الجهاز بالكامل، وضمان كاريير 5 سنوات شامل.'
    },
    {
      q: 'ما هو الفرق بين فريون R32 و R410A وكيف يتم الشحن؟',
      a: 'الأجهزة تعمل بفريون R32 و R410A حسب الموديل، وكلاهما معتمد وصديق للبيئة بكفاءة تبريد عالية وتحمل للحرارة الشديدة. يتم الشحن بعد فاكيوم واختبار ضغط النيتروجين لضمان عدم وجود تسريب.'
    }
  ];
