...
export const FAQSection = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'جميع أجهزتنا جديدة بالكرتونة الأصلية. الضمان 10 سنوات على الكمبروسور و 5 سنوات على الجهاز بالكامل معتمد من الماركة (كاريير، ميديا، شارب، إل جي، أوكس، بلوتو). تربو كوول وكيل معتمد لهذه الماركات في مصر.'
    },
    {
