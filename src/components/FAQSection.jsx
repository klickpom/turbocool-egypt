...
export const FAQSection = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'نعم. التوريد والتركيب مجاني خلال 24 ساعة لجميع الأجهزة في الجيزة والقاهرة الكبرى. بعد طلبك عبر الموقع أو الواتساب يتواصل معك مهندس التنسيق لتأكيد الموعد في نفس اليوم أو خلال 24 ساعة.'
    },
    {
      q: 'ما هي مدة الضمان وهل الأجهزة أصلية بضمان الوكيل؟',
      a: 'جميع أجهزتنا جديدة بالكرتونة الأصلية. تكييفات أوكس بضمان 10 سنوات على الكمبروسور و 5 على الجهاز بالكامل معتمد من Aux، وتكييفات كاريير بضمان 5 سنوات شامل. تربو كوول وكيل معتمد لكاريير وميديا وشارب وإل جي وأوكس وبلوتو.'
    },
    {
